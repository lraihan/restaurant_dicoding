...
MaterialColor primaryColor =
    MaterialColor(AppColors.primary500.value, const <int, Color>{
...
MaterialColor secondaryColor =
    MaterialColor(AppColors.secondary500.value, <int, Color>{
...
MaterialColor neutralColor =
    MaterialColor(AppColors.neutral500.value, <int, Color>{
...
MaterialColor whiteColor = MaterialColor(AppColors.white500.value, <int, Color>{
...
MaterialColor blackColor = MaterialColor(AppColors.black500.value, <int, Color>{
...
MaterialColor errorColor = MaterialColor(AppColors.error500.value, <int, Color>{
...
MaterialColor positiveColor =
    MaterialColor(AppColors.positive500.value, <int, Color>{
